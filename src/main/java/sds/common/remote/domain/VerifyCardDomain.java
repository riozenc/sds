...
public class VerifyCardDomain {
	...
	private String channel_code = "";// 支付通道 1.1 s.50 WXPAY：微信 ALIPAY：支付宝
										// UNIPAY:银联
										// 必填
	...
	private String blImg;// bl_img 营业执照照片 1.1 图片信息 选填
	private String doorImg;// door_img 门头照片 1.1 图片信息 选填
