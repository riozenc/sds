...
public class Common {
	...
	// 请求URL
	public static final String URL = "http://mdx.branding.chinavalleytech.com/ChannelConn/Kubei";
	// 实时注册接口
	public static final String REGISTERURL = "http://mdx.branding.chinavalleytech.com/ChannelConn/rlregister";

	// // 公钥
	// public static final String PUBLICKKEY =
	// "";
	// // Key
	// public static final String KEY = "BD161A60C8933E7EC1D1B802376D6245";
	// // 请求URL
	// public static final String URL =
	// "http://callback.chinavalleytech.com/hfcb/Kubei";
	// // 实时注册接口
	// public static final String REGISTERURL =
	// "http://callback.chinavalleytech.com/hfcb/rlregister";

	public static final String CBZID = "820170116153208273474";

	public static final String CODE = "648532";
}
